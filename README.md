...
8. [Firework CSS](https://codepen.io/yshlin/details/ylDEk)
9. [Font Awesome](https://fontawesome.com/license/free)
10. [DevExpress ASP.NET reporting](https://www.devexpress.com/Support/EULAs/reporting.xml)
11. [DevExpress ASP.NET controls](https://www.devexpress.com/Support/EULAs/asp-net-controls.xml)
12. [Microsoft ASP.NET Web Forms components and Entity Framework](https://licenses.nuget.org/Apache-2.0)
13. [EPPlus noncommercial](https://github.com/EPPlusSoftware/EPPlus/blob/develop/license.md)
14. [Twilio REST API helper library](https://github.com/twilio/twilio-csharp/blob/master/LICENSE.md)
15. [SendGrid client library](https://licenses.nuget.org/MIT)
