...
{
    public partial class RptBOQFCCV2Change : Pyramid.Reports.PreBuiltReports.MasterReports.RptLogoMaster
    {
        public RptBOQFCCV2Change()
        {
            InitializeComponent();
        }
        ...
        private void IndicatorLabel_BeforePrint(object sender, CancelEventArgs e)
        {
                    ...
                    && currentProgramFK == previousProgramFK)
            {
                ...
                if (previousValue != null && currentValue != null)
                {
                    ...
                    int currentValueInt = (currentValue == "not in place" ? 0 :
                                                currentValue == "partially in place" ? 1 :
                                                currentValue == "in place" ? 2 : 0);
                    int previousValueInt = (previousValue == "not in place" ? 0 :
