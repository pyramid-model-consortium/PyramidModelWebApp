...
{
    public partial class RptBOQFCCV2Trend : Pyramid.Reports.PreBuiltReports.MasterReports.RptLogoMaster
    {
        public RptBOQFCCV2Trend()
        {
            InitializeComponent();
        }
        ...
        class GroupedValues
        {
            ...
            public int? TotalOfAllIndicators => InPlaceIndicators + PartialIndicators + NotInPlaceIndicators;
        ...
        private void RptBOQFCCV2Trend_BeforePrint(object sender, System.ComponentModel.CancelEventArgs e)
        {
