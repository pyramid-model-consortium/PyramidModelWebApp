...
{
    public partial class RptBOQSLTChange : Pyramid.Reports.PreBuiltReports.MasterReports.RptLogoMaster
    {
        public RptBOQSLTChange()
        {
            InitializeComponent();
        }
        ...
        private void IndicatorLabel_BeforePrint(object sender, CancelEventArgs e)
        {
            ...
            //Get the current and previous state FK
            string currentStateFK = (GetCurrentColumnValue("StateFK") == null ? null : GetCurrentColumnValue("StateFK").ToString());
            string previousStateFK = (GetPreviousColumnValue("StateFK") == null ? null : GetPreviousColumnValue("StateFK").ToString());
            ...
            if (int.TryParse(currentValue, out int intCurrentValue))
            {
                ...
                if (int.TryParse(previousValue, out int intPreviousValue))
                {
                    ...
                    if (currentStateFK != null && previousStateFK != null
                        && currentStateFK == previousStateFK)
                    {
