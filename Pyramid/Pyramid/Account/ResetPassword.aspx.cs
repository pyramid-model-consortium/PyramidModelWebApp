...
namespace Pyramid.Account
{
    public partial class ResetPassword : Page
    {
        ...
        /// submitResetPassword user control and it changes the user's password
        /// </summary>
        /// <param name="sender">The submitResetPassword control</param>
        ...
        /// <param name="sender">The submitResetPassword control</param>
        /// <param name="e">The Click event</param>
        protected void submitResetPassword_CancelClick(object sender, EventArgs e)
        {
        ...
        protected void submitResetPassword_ValidationFailed(object sender, EventArgs e)
        {
