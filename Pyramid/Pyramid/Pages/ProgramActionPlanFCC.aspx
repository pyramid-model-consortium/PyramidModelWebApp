<%@ Page Title="FCC Action Plan" Language="C#" MasterPageFile="~/MasterPages/Dashboard.master" AutoEventWireup="true" CodeBehind="ProgramActionPlanFCC.aspx.cs" Inherits="Pyramid.Pages.ProgramActionPlanFCC" %>
        ...
        function initializePage() {
            ...
            $('#btnLeadershipCoachHelp').popover({
                ...
                content: 'In order for a leadership coach to appear in this list, they must have ' +
                    'an account in PIDS with a Leadership Coach role associated with the selected program.'
            });
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel ID="upBasicInfo" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
        <ContentTemplate>
            <asp:HiddenField ID="hfProgramActionPlanFCCPK" runat="server" Value="" />
            <div class="row">
                <div class="col-lg-12">
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <dx:BootstrapComboBox ID="ddProgram" runat="server" Caption="Program" NullText="--Select--"
                                        ...
                                        OnValidation="ddProgram_Validation" OnValueChanged="ddProgram_ValueChanged">
                                ...
                                <div class="col-lg-4">
                                    <asp:Label runat="server" AssociatedControlID="lblProgramStartDate" CssClass="d-block col-form-label" Text="Program Launch Date"></asp:Label>
                                    <asp:Label ID="lblProgramStartDate" runat="server"></asp:Label>
                                </div>
                                <div class="col-lg-4">
                                    <asp:Label runat="server" AssociatedControlID="lblProgramCohort" CssClass="d-block col-form-label" Text="Program Cohort"></asp:Label>
                                    <asp:Label ID="lblProgramCohort" runat="server"></asp:Label>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-4">
    ...
    <div id="divEditOnly" runat="server" visible="false">
        <div class="row">
            <div class="col-xl-12">
                <asp:UpdatePanel ID="upLeadershipTeamMembers" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
                        ...
                        <div class="card bg-light bold-border">
                            ...
                            <div class="card-body">
                                <div class="alert alert-primary">
                                    <i class="fas fa-info-circle"></i>&nbsp;This section is automatically filled based on the Program and action plan timeframe in the Basic Information section.
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                        <label>All active Leadership Team members from the Program Leadership Team dashboard</label>
                                        <asp:Repeater ID="repeatLeadershipTeamMembers" runat="server" ItemType="Pyramid.Models.PLTMember">
                                            <HeaderTemplate>
                    ...
                    <Triggers>
                        <asp:AsyncPostBackTrigger ControlID="ddProgram" />
                        ...
                        <div class="card bg-light bold-border">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="alert alert-primary">
                                            <i class="fas fa-info-circle"></i>&nbsp;This section should be used to record all the Program Leadership Team meeting dates.
                                        </div>
                                        <label>All meeting dates for the action plan timeframe</label>
                                        <asp:Repeater ID="repeatMeetings" runat="server" ItemType="Pyramid.Models.ProgramActionPlanFCCMeeting">
                                            <HeaderTemplate>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                ...
                                                                <button class="dropdown-item delete-gridview hide-on-view" data-pk='<%# Item.ProgramActionPlanFCCMeetingPK %>' data-hf="hfDeleteMeetingPK" data-target="#divDeleteMeetingModal"><i class="fas fa-trash"></i>&nbsp;Delete</button>
                                                            </div>
                                                        </div>
                                                        <asp:Label ID="lblMeetingPK" runat="server" Visible="false" Text='<%# Item.ProgramActionPlanFCCMeetingPK %>'></asp:Label>
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
                                            <FooterTemplate>
                ...
                <asp:UpdatePanel ID="upLeadershipCoachSchedule" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
                    <ContentTemplate>
                        <div class="card bg-light bold-border">
                            ...
                            <div class="card-body">
                                <div class="alert alert-primary">
                                    <i class="fas fa-info-circle"></i>&nbsp;This meeting date section is automatically filled based on the Program and action plan timeframe in the Basic Information section.  The only Leadership Coach schedules that will appear below will be for the selected Program and selected action plan timeframe.
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                        <label>All meeting dates from the Leadership Coach dashboard</label>
                                        <asp:Repeater ID="repeatLeadershipCoachSchedule" runat="server" ItemType="Pyramid.Models.ProgramLCMeetingSchedule">
                                            <HeaderTemplate>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <asp:Repeater ID="repeatGroundRules" runat="server" ItemType="Pyramid.Models.ProgramActionPlanFCCGroundRule">
                                            <HeaderTemplate>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                ...
                                                                <button class="dropdown-item delete-gridview hide-on-view" data-pk='<%# Item.ProgramActionPlanFCCGroundRulePK %>' data-hf="hfDeleteGroundRulePK" data-target="#divDeleteGroundRuleModal"><i class="fas fa-trash"></i>&nbsp;Delete</button>
                                                            </div>
                                                        </div>
                                                        <asp:Label ID="lblGroundRulePK" runat="server" Visible="false" Text='<%# Item.ProgramActionPlanFCCGroundRulePK %>'></asp:Label>
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
                                            <FooterTemplate>
                                        ...
                                        <div id="divAddEditGroundRule" runat="server" class="card mt-2" visible="false">
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <dx:BootstrapMemo ID="txtGroundRuleDescription" runat="server" Caption="Ground Rule" 
                                                            MaxLength="3000" Rows="4" OnValidation="txtGroundRuleDescription_Validation">
                                                            <CaptionSettings RequiredMarkDisplayMode="Hidden" ShowColon="false" />
                                                            <ValidationSettings ValidationGroup="vgGroundRule" ErrorDisplayMode="ImageWithText" EnableCustomValidation="true">
                                                                <RequiredField IsRequired="true" ErrorText="Ground Rule is required!" />
                                                            </ValidationSettings>
                                                        </dx:BootstrapMemo>
                                                    </div>
                                                </div>
        ...
        <asp:UpdatePanel ID="upProgramAndBOQInfo" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
            <ContentTemplate>
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card bg-light bold-border">
                            <div class="card-header">
                                Program Staff Information (Section 6)
                            </div>
                            <div class="card-body">
                                <div class="alert alert-primary">
                                    <i class="fas fa-info-circle"></i>&nbsp;This section is automatically filled based on the Program and action plan timeframe in the Basic Information section.
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <asp:Label runat="server" AssociatedControlID="lblTotalEmployees" CssClass="d-block col-form-label" Text="Total Number of Active Staff in PIDS"></asp:Label>
                                        <asp:Label ID="lblTotalEmployees" runat="server"></asp:Label>
                                    </div>
                                    <div class="col-lg-12">
                                        <asp:Label runat="server" AssociatedControlID="lblTotalEmployeesHired" CssClass="d-block col-form-label" Text="Number of Staff Hired"></asp:Label>
                                        <asp:Label ID="lblTotalEmployeesHired" runat="server"></asp:Label>
                                    </div>
                                    <div class="col-lg-12">
                                        <asp:Label runat="server" AssociatedControlID="lblTotalEmployeesTerminated" CssClass="d-block col-form-label" Text="Number of Staff Terminated"></asp:Label>
                                        <asp:Label ID="lblTotalEmployeesTerminated" runat="server"></asp:Label>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card bg-light bold-border">
                            ...
                            <div class="card-body">
                                <div class="alert alert-primary">
                                    <i class="fas fa-info-circle"></i>&nbsp;This section is automatically filled based on the Program and timeframe in the Basic Information section.  
                                    It pulls the most recent Benchmark of Quality form for the program that is on or before the action plan end date and on or after the action plan start date minus six months.
                                    The table below displays all the indicators that are Not In Place, Partially In Place, or NA.
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <asp:Repeater ID="repeatBOQIndicatorsToBeImproved" runat="server" ItemType="Pyramid.Models.spGetBOQFCCIndicatorValues_Result">
                                            <HeaderTemplate>
                                            ...
                                            <ItemTemplate>
                                                <tr class='<%# (Item.IndicatorValue == (int)Pyramid.Models.CodeBOQIndicatorValue.BOQFCCV2IndicatorValues.PARTIALLY_IN_PLACE ? "alert-warning"
                                                                : Item.IndicatorValue == (int)Pyramid.Models.CodeBOQIndicatorValue.BOQFCCV2IndicatorValues.NOT_IN_PLACE ? "alert-danger"
                                                                : "") %>'>
                                                    <td></td>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <asp:Repeater ID="repeatActionSteps" runat="server" ItemType="Pyramid.Models.ProgramActionPlanFCCActionStep">
                                            <HeaderTemplate>
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td><%# (Item.ProgramActionPlanFCCActionStepStatus.OrderByDescending(s => s.StatusDate).FirstOrDefault() == null ? "N/A" : Item.ProgramActionPlanFCCActionStepStatus.OrderByDescending(s => s.StatusDate).FirstOrDefault().CodeActionPlanActionStepStatus.Description) %></td>
                                                    <td class="text-center">
                                                        <div class="btn-group">
                                                            <button type="button" class="btn btn-secondary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                                Actions
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                ...
                                                                <button class="dropdown-item delete-gridview hide-on-view" data-pk='<%# Item.ProgramActionPlanFCCActionStepPK %>' data-hf="hfDeleteActionStepPK" data-target="#divDeleteActionStepModal"><i class="fas fa-trash"></i>&nbsp;Delete</button>
                                                            </div>
                                                        </div>
                                                        <asp:Label ID="lblActionStepPK" runat="server" Visible="false" Text='<%# Item.ProgramActionPlanFCCActionStepPK %>'></asp:Label>
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
                                            <FooterTemplate>
                                                            ...
                                                            <div class="card-body">
                                                                <div class="row">
                                                                    <div class="col-lg-12">
                                                                        ...
                                                                        <asp:Repeater ID="repeatActionStepStatuses" runat="server" ItemType="Pyramid.Models.ProgramActionPlanFCCActionStepStatus">
                                                                            <HeaderTemplate>
                                                                                    ...
                                                                                    <td class="text-center">
                                                                                        <div class="btn-group">
                                                                                            ...
                                                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                                                ...
                                                                                                <button class="dropdown-item delete-gridview hide-on-view" data-pk='<%# Item.ProgramActionPlanFCCActionStepStatusPK %>' data-hf="hfDeleteActionStepStatusPK" data-target="#divDeleteActionStepStatusModal"><i class="fas fa-trash"></i>&nbsp;Delete</button>
                                                                                            </div>
                                                                                        </div>
                                                                                        <asp:Label ID="lblActionStepStatusPK" runat="server" Visible="false" Text='<%# Item.ProgramActionPlanFCCActionStepStatusPK %>'></asp:Label>
                                                                                    </td>
                                                                                </tr>
                                                                            </ItemTemplate>
                                                                            <FooterTemplate>
