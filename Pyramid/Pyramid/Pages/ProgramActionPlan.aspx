<%@ Page Title="Action Plan" Language="C#" MasterPageFile="~/MasterPages/Dashboard.master" AutoEventWireup="true" CodeBehind="ProgramActionPlan.aspx.cs" Inherits="Pyramid.Pages.ProgramActionPlan" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel ID="upBasicInfo" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
        <ContentTemplate>
            <asp:HiddenField ID="hfProgramActionPlanPK" runat="server" Value="" />
            <div class="row">
                <div class="col-lg-12">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <asp:Repeater ID="repeatMeetings" runat="server" ItemType="Pyramid.Models.ProgramActionPlanMeeting">
                                            <HeaderTemplate>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                ...
                                                                <button class="dropdown-item delete-gridview hide-on-view" data-pk='<%# Item.ProgramActionPlanMeetingPK %>' data-hf="hfDeleteMeetingPK" data-target="#divDeleteMeetingModal"><i class="fas fa-trash"></i>&nbsp;Delete</button>
                                                            </div>
                                                        </div>
                                                        <asp:Label ID="lblMeetingPK" runat="server" Visible="false" Text='<%# Item.ProgramActionPlanMeetingPK %>'></asp:Label>
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
                                            <FooterTemplate>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <asp:Repeater ID="repeatGroundRules" runat="server" ItemType="Pyramid.Models.ProgramActionPlanGroundRule">
                                            <HeaderTemplate>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                ...
                                                                <button class="dropdown-item delete-gridview hide-on-view" data-pk='<%# Item.ProgramActionPlanGroundRulePK %>' data-hf="hfDeleteGroundRulePK" data-target="#divDeleteGroundRuleModal"><i class="fas fa-trash"></i>&nbsp;Delete</button>
                                                            </div>
                                                        </div>
                                                        <asp:Label ID="lblGroundRulePK" runat="server" Visible="false" Text='<%# Item.ProgramActionPlanGroundRulePK %>'></asp:Label>
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
                                            <FooterTemplate>
                        ...
                        <div class="card bg-light bold-border">
                            ...
                            <div class="card-body">
                                <div class="alert alert-primary">
                                    ...
                                    The table below displays all the indicators that are either Not In Place or Partially In Place.
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <asp:Repeater ID="repeatBOQIndicatorsToBeImproved" runat="server" ItemType="Pyramid.Models.spGetBOQIndicatorValues_Result">
                                            <HeaderTemplate>
                                            ...
                                            <ItemTemplate>
                                                <tr class='<%# (Item.IndicatorValue == (int)Pyramid.Models.CodeBOQIndicatorValue.BOQIndicatorValues.PARTIALLY_IN_PLACE ? "alert-warning"
                                                                : Item.IndicatorValue == (int)Pyramid.Models.CodeBOQIndicatorValue.BOQIndicatorValues.NOT_IN_PLACE ? "alert-danger"
                                                                : "") %>'>
                                                    <td></td>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <asp:Repeater ID="repeatActionSteps" runat="server" ItemType="Pyramid.Models.ProgramActionPlanActionStep">
                                            <HeaderTemplate>
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td><%# (Item.ProgramActionPlanActionStepStatus.OrderByDescending(s => s.StatusDate).FirstOrDefault() == null ? "N/A" : Item.ProgramActionPlanActionStepStatus.OrderByDescending(s => s.StatusDate).FirstOrDefault().CodeActionPlanActionStepStatus.Description) %></td>
                                                    <td class="text-center">
                                                        <div class="btn-group">
                                                            <button type="button" class="btn btn-secondary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                                Actions
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                ...
                                                                <button class="dropdown-item delete-gridview hide-on-view" data-pk='<%# Item.ProgramActionPlanActionStepPK %>' data-hf="hfDeleteActionStepPK" data-target="#divDeleteActionStepModal"><i class="fas fa-trash"></i>&nbsp;Delete</button>
                                                            </div>
                                                        </div>
                                                        <asp:Label ID="lblActionStepPK" runat="server" Visible="false" Text='<%# Item.ProgramActionPlanActionStepPK %>'></asp:Label>
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
                                            <FooterTemplate>
                                                            ...
                                                            <div class="card-body">
                                                                <div class="row">
                                                                    <div class="col-lg-12">
                                                                        ...
                                                                        <asp:Repeater ID="repeatActionStepStatuses" runat="server" ItemType="Pyramid.Models.ProgramActionPlanActionStepStatus">
                                                                            <HeaderTemplate>
                                                                                    ...
                                                                                    <td class="text-center">
                                                                                        <div class="btn-group">
                                                                                            ...
                                                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                                                ...
                                                                                                <button class="dropdown-item delete-gridview hide-on-view" data-pk='<%# Item.ProgramActionPlanActionStepStatusPK %>' data-hf="hfDeleteActionStepStatusPK" data-target="#divDeleteActionStepStatusModal"><i class="fas fa-trash"></i>&nbsp;Delete</button>
                                                                                            </div>
                                                                                        </div>
                                                                                        <asp:Label ID="lblActionStepStatusPK" runat="server" Visible="false" Text='<%# Item.ProgramActionPlanActionStepStatusPK %>'></asp:Label>
                                                                                    </td>
                                                                                </tr>
                                                                            </ItemTemplate>
                                                                            <FooterTemplate>
