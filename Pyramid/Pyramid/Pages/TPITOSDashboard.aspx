...
<asp:Content ID="Content2" ContentPlaceHolderID="ScriptContent" runat="server">
    <script>
        ...
        function initializePage() {
            ...
            //Get any incomplete TPITOS rows
            var incompleteRows = $('.incomplete-tpitos');
        ...
        function setViewOnlyVisibility() {
            ...
            var isTPITOSView = $('[ID$="hfTPITOSViewOnly"]').val();
            if (isTPITOSView == 'True') {
                $('.tpitos-hide-on-view').addClass('hidden');
            }
            else {
                $('.tpitos-hide-on-view').removeClass('hidden');
            }
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <asp:HiddenField ID="hfTPITOSViewOnly" runat="server" Value="False" />
    ...
    <asp:UpdatePanel ID="upDashboardMessaging" runat="server" UpdateMode="Conditional">
        ...
        <Triggers>
            ...
            <asp:AsyncPostBackTrigger ControlID="bsGRTPITOS" />
    ...
    <div id="divTPITOS" runat="server" class="row">
                ...
                <ContentTemplate>
                    <div class="card bg-light">
                        <div class="card-header">
                            TPITOS Observations
                            <a href="/Pages/TPITOS.aspx?TPITOSPK=0&action=Add" class="btn btn-loader btn-primary float-right tpitos-hide-on-view hidden"><i class="fas fa-plus"></i>&nbsp;Add New TPITOS Observation</a>
                        </div>
                        <div class="card-body">
                                        ...
                                        <DataItemTemplate>
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <a class="dropdown-item tpitos-hide-on-view" href='<%# string.Format("/Pages/TPITOS.aspx?TPITOSPK={0}&action={1}",Eval("TPITOSPK").ToString(),"edit") %>'><i class="fas fa-edit"></i>&nbsp;Edit</a>
                                                    <button class="dropdown-item delete-gridview tpitos-hide-on-view" data-pk='<%# Eval("TPITOSPK") %>' data-hf="hfDeleteTPITOSPK" data-target="#divDeleteTPITOSModal"><i class="fas fa-trash"></i>&nbsp;Delete</button>
                                                </div>
                                            </div>
                                        </DataItemTemplate>
        ...
        <div class="col-xl-12">
            ...
            <asp:UpdatePanel ID="upFormSchedule" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
                <ContentTemplate>
                    <div class="card bg-light">
                        <div class="card-header">
                            <span class="font-weight-bold">TPITOS Schedule</span>
    ...
    <div class="modal" id="divDeleteFormScheduleModal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Are you sure you want to delete this TPITOS Schedule?
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal"><i class="fas fa-times"></i>&nbsp;No</button>
