<%@ Page Title="SLT Member" Language="C#" MasterPageFile="~/MasterPages/Dashboard.master" AutoEventWireup="true" CodeBehind="SLTMember.aspx.cs" Inherits="Pyramid.Pages.SLTMember" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ScriptContent" runat="server">
    <script type="text/javascript">
        ...
        function initializePage() {
            ...
            if (!$.fn.dataTable.isDataTable('#tblWorkGroupAssignments')) {
                $('#tblWorkGroupAssignments').DataTable({
                    responsive: {
                        details: {
                            type: 'column'
                        }
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <asp:Label ID="lblPageTitle" runat="server" Text="State Leadership Team Member" CssClass="h2"></asp:Label>
    <hr />
    ...
    <asp:UpdatePanel ID="upMessaging" runat="server" UpdateMode="Conditional">
        ...
        <Triggers>
            ...
            <asp:AsyncPostBackTrigger ControlID="lbAddWorkGroupAssignment" EventName="Click" />
            <asp:AsyncPostBackTrigger ControlID="repeatWorkGroupAssignments" />
            <asp:AsyncPostBackTrigger ControlID="lbDeleteWorkGroupAssignment" EventName="Click" />
            <asp:AsyncPostBackTrigger ControlID="submitWorkGroupAssignment" />
            <asp:AsyncPostBackTrigger ControlID="btnPrintPreview" EventName="Click" />
            <asp:AsyncPostBackTrigger ControlID="submitSLTMember" />
        </Triggers>
    </asp:UpdatePanel>
    <asp:UpdatePanel ID="upBasicInfo" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
        <ContentTemplate>
            <asp:HiddenField ID="hfSLTMemberPK" runat="server" Value="" />
            <div class="row">
                <div class="col-lg-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <dx:BootstrapButton ID="btnPrintPreview" runat="server" Text="Save and Download/Print" OnClick="btnPrintPreview_Click"
                                        SettingsBootstrap-RenderOption="primary" ValidationGroup="vgSLTMember" data-validation-group="vgSLTMember">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <dx:BootstrapTextBox ID="txtFirstName" runat="server" Caption="First Name" MaxLength="250">
                                            ...
                                            <ValidationSettings ValidationGroup="vgSLTMember" ErrorDisplayMode="ImageWithText">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <dx:BootstrapTextBox ID="txtIDNumber" runat="server" Caption="ID Number" MaxLength="100"
                                            ...
                                            <CaptionSettings RequiredMarkDisplayMode="Hidden" ShowColon="false" />
                                            <ValidationSettings ValidationGroup="vgSLTMember" ErrorDisplayMode="ImageWithText" EnableCustomValidation="true">
    ...
    <div id="divEditOnly" runat="server" visible="false">
                    ...
                    <ContentTemplate>
                        <div class="card bg-light">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <label>All Agency Assignments for this SLT Member</label>
                                        <asp:Repeater ID="repeatAgencyAssignments" runat="server" ItemType="Pyramid.Models.SLTMemberAgencyAssignment">
                                            <HeaderTemplate>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                ...
                                                                <button class="dropdown-item delete-gridview" data-pk='<%# Item.SLTMemberAgencyAssignmentPK %>' data-hf="hfDeleteAgencyAssignmentPK" data-target="#divDeleteAgencyAssignmentModal"><i class="fas fa-trash"></i>&nbsp;Delete</button>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <asp:Label ID="lblAgencyFK" runat="server" Visible="false" Text='<%# Item.SLTAgencyFK %>'></asp:Label>
                                                        <asp:Label ID="lblAgencyAssignmentPK" runat="server" Visible="false" Text='<%# Item.SLTMemberAgencyAssignmentPK %>'></asp:Label>
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
                                            <FooterTemplate>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="form-group">
                                                            <dx:BootstrapComboBox ID="ddAssignmentAgency" runat="server" Caption="Agency" NullText="--Select--" ValueType="System.Int32"
                                                                TextField="Name" ValueField="SLTAgencyPK"
        ...
        <div class="row">
            <div class="col-xl-12">
                <asp:HiddenField ID="hfDeleteWorkGroupAssignmentPK" runat="server" Value="0" />
                <asp:UpdatePanel ID="upWorkGroupAssignment" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
                    <ContentTemplate>
                        <div class="card bg-light">
                            <div class="card-header">
                                Work Group Assignments
                                <asp:LinkButton ID="lbAddWorkGroupAssignment" runat="server" CssClass="btn btn-loader btn-primary float-right hide-on-view hidden" OnClick="lbAddWorkGroupAssignment_Click"><i class="fas fa-plus"></i> Add New Assignment</asp:LinkButton>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <label>All Work Group Assignments for this SLT Member</label>
                                        <asp:Repeater ID="repeatWorkGroupAssignments" runat="server" ItemType="Pyramid.Models.SLTMemberWorkGroupAssignment">
                                            <HeaderTemplate>
                                                <table id="tblWorkGroupAssignments" class="table table-striped table-bordered table-hover">
                                                    <thead>
                                                        <tr>
                                                            <th data-priority="1"></th>
                                                            <th data-priority="3">Work Group</th>
                                                            <th data-priority="4">Start Date</th>
                                                            <th data-priority="5">End Date</th>
                                                            <th data-priority="2"></th>
                                                        </tr>
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    <td></td>
                                                    <td><%# Item.SLTWorkGroup.WorkGroupName %></td>
                                                    <td><%# Item.StartDate.ToString("MM/dd/yyyy") %></td>
                                                    <td class="leave-date"><%# (Item.EndDate.HasValue ? Item.EndDate.Value.ToString("MM/dd/yyyy") : "") %></td>
                                                    <td class="text-center">
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                <asp:LinkButton ID="lbEditWorkGroupAssignment" runat="server" CssClass="dropdown-item" OnClick="lbEditWorkGroupAssignment_Click"><i class="fas fa-edit"></i>&nbsp;Edit</asp:LinkButton>
                                                                <button class="dropdown-item delete-gridview" data-pk='<%# Item.SLTMemberWorkGroupAssignmentPK %>' data-hf="hfDeleteWorkGroupAssignmentPK" data-target="#divDeleteWorkGroupAssignmentModal"><i class="fas fa-trash"></i>&nbsp;Delete</button>
                                                            </div>
                                                        </div>
                                                        <!-- Need to use labels so that values are maintained after postback (inputs get cleared because of an interaction with DataTables and the repeater) -->
                                                        <asp:Label ID="lblWorkGroupFK" runat="server" Visible="false" Text='<%# Item.SLTWorkGroupFK %>'></asp:Label>
                                                        <asp:Label ID="lblWorkGroupAssignmentPK" runat="server" Visible="false" Text='<%# Item.SLTMemberWorkGroupAssignmentPK %>'></asp:Label>
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
                                            <FooterTemplate>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div id="divAddEditWorkGroupAssignment" runat="server" class="card mt-2" visible="false">
                                            <div class="card-header">
                                                <asp:Label ID="lblAddEditWorkGroupAssignment" runat="server" Text=""></asp:Label>
                                            </div>
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="alert alert-primary">
                                                        <i class="fas fa-info-circle"></i>&nbsp;The start and end dates determine which Work Groups appear in the Work Group list.  Only Work Groups that were active between the start and end date will appear in the list.  You must enter the start date before the Work Group list will populate with options.
                                                    </div>
                                                    <div class="col-lg-4">
                                                        <div class="form-group">
                                                            <dx:BootstrapDateEdit ID="deWGAStartDate" runat="server" Caption="Start Date" UseMaskBehavior="true"
                                                                EditFormat="Date" EditFormatString="MM/dd/yyyy" AutoPostBack="true"
                                                                OnValueChanged="deWGADateChanged_ValueChanged" OnValidation="deWGAStartDate_Validation" 
                                                                AllowMouseWheel="false" PickerDisplayMode="Calendar" MinDate="01/01/1900">
                                                                <CaptionSettings RequiredMarkDisplayMode="Hidden" ShowColon="false" />
                                                                <SettingsAdaptivity Mode="OnWindowInnerWidth" SwitchToModalAtWindowInnerWidth="750" />
                                                                <CalendarProperties ShowClearButton="true"></CalendarProperties>
                                                                <ValidationSettings ValidationGroup="vgWorkGroupAssignment" ErrorDisplayMode="ImageWithText">
                                                                    <RequiredField IsRequired="true" ErrorText="Start Date is required!" />
                                                                </ValidationSettings>
                                                            </dx:BootstrapDateEdit>
                                                        </div>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="form-group">
                                                            <dx:BootstrapComboBox ID="ddWGAWorkGroup" runat="server" Caption="Work Group" NullText="--Select--" ValueType="System.Int32"
                                                                TextField="WorkGroupName" ValueField="SLTWorkGroupPK" 
                                                                IncrementalFilteringMode="Contains" AllowMouseWheel="false"
                                                                ClientInstanceName="ddAssignmentWorkGroup">
                                                                <CaptionSettings RequiredMarkDisplayMode="Hidden" ShowColon="false" />
                                                                <ValidationSettings ValidationGroup="vgWorkGroupAssignment" ErrorDisplayMode="ImageWithText">
                                                                    <RequiredField IsRequired="true" ErrorText="Work Group is required!" />
                                                                </ValidationSettings>
                                                            </dx:BootstrapComboBox>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4">
                                                        <div class="form-group">
                                                            <dx:BootstrapDateEdit ID="deWGAEndDate" runat="server" Caption="End Date" UseMaskBehavior="true"
                                                                EditFormat="Date" EditFormatString="MM/dd/yyyy" AutoPostBack="true" AllowNull="true"
                                                                OnValueChanged="deWGADateChanged_ValueChanged" OnValidation="deWGAEndDate_Validation" 
                                                                AllowMouseWheel="false" PickerDisplayMode="Calendar" MinDate="01/01/1900">
                                                                <CaptionSettings RequiredMarkDisplayMode="Hidden" ShowColon="false" />
                                                                <SettingsAdaptivity Mode="OnWindowInnerWidth" SwitchToModalAtWindowInnerWidth="750" />
                                                                <CalendarProperties ShowClearButton="true"></CalendarProperties>
                                                                <ValidationSettings ValidationGroup="vgWorkGroupAssignment" ErrorDisplayMode="ImageWithText" EnableCustomValidation="true">
                                                                    <RequiredField IsRequired="false" ErrorText="End Date is required!" />
                                                                </ValidationSettings>
                                                            </dx:BootstrapDateEdit>
                                                        </div>
                                            ...
                                            <div class="card-footer">
                                                <div class="center-content">
                                                    <asp:HiddenField ID="hfAddEditWorkGroupAssignmentPK" runat="server" Value="0" />
                                                    <uc:Submit ID="submitWorkGroupAssignment" runat="server" 
                                                        ValidationGroup="vgWorkGroupAssignment"
                                                        ControlCssClass="center-content"
                                                        OnSubmitClick="submitWorkGroupAssignment_Click" 
                                                        OnCancelClick="submitWorkGroupAssignment_CancelClick" 
                                                        OnValidationFailed="submitWorkGroupAssignment_ValidationFailed" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <div class="page-footer">
        <uc:Submit ID="submitSLTMember" runat="server" ValidationGroup="vgSLTMember"
            ControlCssClass="center-content"
            OnSubmitClick="submitSLTMember_Click" OnCancelClick="submitSLTMember_CancelClick" 
            OnValidationFailed="submitSLTMember_ValidationFailed" />
    </div>
    ...
    <div class="modal" id="divDeleteWorkGroupAssignmentModal">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Delete Work Group Assignment</h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body">
                    Are you sure you want to delete this work group assignment?
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal"><i class="fas fa-times"></i>&nbsp;No</button>
                    <asp:LinkButton ID="lbDeleteWorkGroupAssignment" runat="server" CssClass="btn btn-loader btn-danger modal-delete" data-target="#divDeleteWorkGroupAssignmentModal" OnClick="lbDeleteWorkGroupAssignment_Click"><i class="fas fa-check"></i> Yes</asp:LinkButton>
                </div>
            </div>
        </div>
    </div>
