...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel ID="upBOQ" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <uc:Messaging ID="msgSys" runat="server" />
            <asp:HiddenField ID="hfBOQPK" runat="server" Value="" />
            <!--main content-->
            <div class="row">
                <div class="col-lg-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <dx:BootstrapButton ID="btnPrintPreview" runat="server" Text="Save and Download/Print" OnClick="btnPrintPreview_Click"
                                        SettingsBootstrap-RenderOption="primary" ValidationGroup="vgBOQ" data-validation-group="vgBOQ">
            ...
            <div class="page-footer">
                <uc:Submit ID="submitBOQ" runat="server" ValidationGroup="vgBOQ"
                    ControlCssClass="center-content"
                    OnSubmitClick="submitBOQ_Click" OnCancelClick="submitBOQ_CancelClick"
                    OnValidationFailed="submitBOQ_ValidationFailed" />
            </div>
        </ContentTemplate>
    </asp:UpdatePanel>
</asp:Content>
