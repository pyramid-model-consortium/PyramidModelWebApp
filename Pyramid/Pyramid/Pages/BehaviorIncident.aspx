...
<asp:Content ID="Content2" ContentPlaceHolderID="ScriptContent" runat="server">
    <script>
        ...
        function showHideProblemBehaviorSpecify() {
            ...
            if (problemBehavior.toLowerCase().includes('other')) {
        ...
        function validateProblemBehaviorSpecify(s, e) {
            ...
            if ((behaviorSpecify == null || behaviorSpecify == ' ') && problemBehavior.toLowerCase().includes('other')) {
                e.isValid = false;
        ...
        function showHideActivitySpecify() {
            ...
            if (activity.toLowerCase().includes('other')) {
        ...
        function validateActivitySpecify(s, e) {
            ...
            if ((activitySpecify == null || activitySpecify == ' ') && activity.toLowerCase().includes('other')) {
                e.isValid = false;
        ...
        function showHideOthersInvolvedSpecify() {
            ...
            if (othersInvolved.toLowerCase().includes('other')) {
        ...
        function validateOthersInvolvedSpecify(s, e) {
            ...
            if ((othersInvolvedSpecify == null || othersInvolvedSpecify == ' ') && othersInvolved.toLowerCase().includes('other')) {
                e.isValid = false;
        ...
        function showHidePossibleMotivationSpecify() {
            ...
            if (possibleMotivation.toLowerCase().includes('other')) {
        ...
        function validatePossibleMotivationSpecify(s, e) {
            ...
            if ((possibleMotivationSpecify == null || possibleMotivationSpecify == ' ') && possibleMotivation.toLowerCase().includes('other')) {
                e.isValid = false;
        ...
        function showHideStrategyResponseSpecify() {
            ...
            if (strategyResponse.toLowerCase().includes('other')) {
        ...
        function validateStrategyResponseSpecify(s, e) {
            ...
            if ((strategyResponseSpecify == null || strategyResponseSpecify == ' ') && strategyResponse.toLowerCase().includes('other')) {
                e.isValid = false;
        ...
        function showHideAdminFollowUpSpecify() {
            ...
            if (adminFollowUp.toLowerCase().includes('other')) {
        ...
        function validateAdminFollowUpSpecify(s, e) {
            ...
            if ((adminFollowUpSpecify == null || adminFollowUpSpecify == ' ') && adminFollowUp.toLowerCase().includes('other')) {
                e.isValid = false;
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel ID="upMessaging" runat="server" UpdateMode="Conditional">
        ...
        <Triggers>
            <asp:AsyncPostBackTrigger ControlID="submitBehaviorIncident" />
        </Triggers>
    </asp:UpdatePanel>
    <!--main content-->
    <div class="row">
        <div class="col-lg-12">
            <div class="card bg-light">
                ...
                <div class="card-body">
                    <asp:UpdatePanel ID="upImportantInfo" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <div class="row">
                                <div class="col-md-6">
                                    <label>Program: </label>
    ...
    <div class="page-footer">
        <uc:Submit ID="submitBehaviorIncident" runat="server" ValidationGroup="vgBehaviorIncident" OnSubmitClick="submitBehaviorIncident_Click" OnCancelClick="submitBehaviorIncident_CancelClick" OnValidationFailed="submitBehaviorIncident_ValidationFailed"></uc:Submit>
    </div>
</asp:Content>
