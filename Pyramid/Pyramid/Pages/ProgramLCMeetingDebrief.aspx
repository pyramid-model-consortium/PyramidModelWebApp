<%@ Page Title="Leadership Coach Debrief Form" Language="C#" MasterPageFile="~/MasterPages/Dashboard.master" AutoEventWireup="true" CodeBehind="ProgramLCMeetingDebrief.aspx.cs" Inherits="Pyramid.Pages.ProgramLCMeetingDebrief" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel ID="upBasicInfo" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
        <ContentTemplate>
            <asp:HiddenField ID="hfProgramLCMeetingDebriefPK" runat="server" Value="" />
            <div class="row">
                <div class="col-lg-12">
                    <div class="card bg-light">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <dx:BootstrapButton ID="btnPrintPreview" runat="server" Text="Save and Download/Print" OnClick="btnPrintPreview_Click"
                                        SettingsBootstrap-RenderOption="primary" ValidationGroup="vgProgramLCMeetingDebrief" data-validation-group="vgProgramLCMeetingDebrief">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2">
                                    <asp:Label runat="server" AssociatedControlID="lblProgramCohort" CssClass="d-block" Text="Cohort"></asp:Label>
                                    <asp:Label ID="lblProgramCohort" runat="server"></asp:Label>
                                </div>
                                <div class="col-lg-2">
                                    <asp:Label runat="server" AssociatedControlID="lblProgramStartDate" CssClass="d-block" Text="Launch Date"></asp:Label>
                        ...
                        <div class="card bg-light">
                            ...
                            <div class="card-body">
                                <div class="alert alert-primary">
                                    <i class="fas fa-info-circle"></i>&nbsp;This section is automatically filled based on the Program and Year in the Basic Information section.
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                        <label>All active Leadership Team members from the Program Leadership Team dashboard</label>
                                        <asp:Repeater ID="repeatTeamMembers" runat="server" ItemType="Pyramid.Models.PLTMember">
                                            <HeaderTemplate>
                ...
                <asp:UpdatePanel ID="upDebriefSession" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
                    <ContentTemplate>
                        <div class="card bg-light">
                            <div class="card-header">
                                Session Debriefs
                                <asp:LinkButton ID="lbAddDebriefSession" runat="server" CssClass="btn btn-loader btn-primary float-right hide-on-view hidden" OnClick="lbAddDebriefSession_Click"><i class="fas fa-plus"></i>&nbsp;Add New Session Debrief</asp:LinkButton>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <label>All session debriefs</label>
                                        <asp:Repeater ID="repeatDebriefSessions" runat="server" ItemType="Pyramid.Models.ProgramLCMeetingDebriefSession">
                                            <HeaderTemplate>
                                                <table id="tblDebriefSessions" class="table table-striped table-bordered table-hover">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th data-priority="8">Reviewed TPITOS?</th>
                                                            <th data-priority="9">Reviewed TPOT?</th>
                                                            <th data-priority="10">Reviewed Other Focus Item(s)?</th>
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    <td></td>
                                                    <td><%# string.Join(", ", Item.ProgramLCMeetingDebriefSessionAttendee.Select(a => string.Format("({0}) {1} {2}", a.PLTMember.IDNumber, a.PLTMember.FirstName, a.PLTMember.LastName)).ToList()) %></td>
                                                    ...
                                                    <td><i class='<%# (Item.ReviewedTPITOS ? "fas fa-check green-text" : "fas fa-times red-text") %>'></i></td>
                                                    <td><i class='<%# (Item.ReviewedTPOT ? "fas fa-check green-text" : "fas fa-times red-text") %>'></i></td>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                ...
                                                                <button class="dropdown-item delete-gridview hide-on-view" data-pk='<%# Item.ProgramLCMeetingDebriefSessionPK %>' data-hf="hfDeleteDebriefSessionPK" data-target="#divDeleteDebriefSessionModal"><i class="fas fa-trash"></i>&nbsp;Delete</button>
                                                            </div>
                                                        </div>
                                                        <asp:Label ID="lblDebriefSessionPK" runat="server" Visible="false" Text='<%# Item.ProgramLCMeetingDebriefSessionPK %>'></asp:Label>
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
                                            <FooterTemplate>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-4">
                                                        <dx:BootstrapTagBox ID="tbDebriefSessionAttendees" runat="server" Caption="Leadership Team Attendees"
                                                            AllowCustomTags="false" TextField="IDNumberAndName" ValueField="PLTMemberPK">
                                                            <CaptionSettings RequiredMarkDisplayMode="Hidden" ShowColon="false" />
                                                        ...
                                                        <button id="lnkDebriefSessionAttendeeHelp" type="button" class="btn btn-link p-0"
                                                            ...
                                                            title="Help" 
                                                            data-content="A program and year must be selected in the Basic Information section before this field will populate.  If the team member you are looking for still isn't listed, the team member wasn't active in the selected program during the selected year.">
                                                    ...
                                                    <div class="col-lg-8">
                                                        ...
                                                        <dx:BootstrapCheckBox ID="chkDebriefSessionReviewedTPITOS" runat="server" Text="TPITOS">
                                                            <SettingsBootstrap InlineMode="true" />
                                                            <ValidationSettings ValidationGroup="vgDebriefSession" ErrorDisplayMode="ImageWithText">
                                                                <RequiredField IsRequired="false" ErrorText="Required!" />
                                                            </ValidationSettings>
                                                        </dx:BootstrapCheckBox>
                                                        <dx:BootstrapCheckBox ID="chkDebriefSessionReviewedTPOT" runat="server" Text="TPOT">
                                                            <SettingsBootstrap InlineMode="true" />
                                                            <ValidationSettings ValidationGroup="vgDebriefSession" ErrorDisplayMode="ImageWithText">
                                                                <RequiredField IsRequired="false" ErrorText="Required!" />
                                                            </ValidationSettings>
