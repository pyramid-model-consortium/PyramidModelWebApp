...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card bg-light">
                ...
                <div class="card-body">
                    <label>BOQ FCC Indicator Legend</label>
                    <div class="row">
    ...
    <div class="page-footer">
        <uc:Submit ID="submitBOQFCC" runat="server" ValidationGroup="vgBOQFCC" OnCancelClick="submitBOQFCC_CancelClick" OnSubmitClick="submitBOQFCC_Click" OnValidationFailed="submitBOQFCC_ValidationFailed" />
    </div>
</asp:Content>
