<%@ Page Title="SLT Action Plan" Language="C#" MasterPageFile="~/MasterPages/Dashboard.master" AutoEventWireup="true" CodeBehind="SLTActionPlan.aspx.cs" Inherits="Pyramid.Pages.SLTActionPlan" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ScriptContent" runat="server">
    <script>
        ...
        function initializePage() {
            ...
            $('#btnWorkGroupLeadHelp').popover({
                trigger: 'hover focus',
                title: 'Help',
                html: true,
                content: 'This list contains State Leadership Team Members that are active in the selected workgroup during the timeframe of the action plan.'
            });
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel ID="upBasicInfo" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
        <ContentTemplate>
            <asp:HiddenField ID="hfSLTActionPlanPK" runat="server" Value="" />
            <div class="row">
                <div class="col-lg-12">
                    <div class="card bg-light bold-border">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-3">
                                    <dx:BootstrapComboBox ID="ddState" runat="server" Caption="State" NullText="--Select--"
                                        TextField="Name" ValueField="StatePK" ValueType="System.Int32" AllowNull="true"
                                        IncrementalFilteringMode="Contains" AllowMouseWheel="false" AutoPostBack="true"
                                        OnValueChanged="ddState_ValueChanged">
                                ...
                                <div class="col-lg-3">
                                    <dx:BootstrapComboBox ID="ddWorkGroup" runat="server" Caption="Work Group" NullText="--Select--"
                                        TextField="WorkGroupName" ValueField="SLTWorkGroupPK" ValueType="System.Int32" AllowNull="true"
                                        IncrementalFilteringMode="Contains" AllowMouseWheel="false" AutoPostBack="true"
                                        OnValidation="ddWorkGroup_Validation" OnValueChanged="ddWorkGroup_ValueChanged">
                                        <CaptionSettings RequiredMarkDisplayMode="Hidden" ShowColon="false" />
                                        <ValidationSettings ValidationGroup="vgActionPlan" ErrorDisplayMode="ImageWithText" EnableCustomValidation="true">
                            ...
                            <div class="row">
                                <div class="col-lg-3">
                                    <asp:Label runat="server" AssociatedControlID="lblActionPlanLastUpdated" CssClass="d-block col-form-label" Text="Date Updated"></asp:Label>
                                    <asp:Label ID="lblActionPlanLastUpdated" runat="server"></asp:Label>
                                </div>
                                <div class="col-lg-3">
                                    <dx:BootstrapComboBox ID="ddWorkGroupLead" runat="server" Caption="State Coordinator" NullText="--Select--" ValueType="System.Int32"
                                        TextField="IDNumberAndName" ValueField="SLTMemberPK" 
                                        IncrementalFilteringMode="Contains" AllowMouseWheel="false"
                                        ClientInstanceName="ddWorkGroupLead" AutoPostBack="true"
                                        OnValueChanged="ddWorkGroupLead_ValueChanged">
                                        <CaptionSettings RequiredMarkDisplayMode="Hidden" ShowColon="false" />
                                        <ValidationSettings ValidationGroup="vgActionPlan" ErrorDisplayMode="ImageWithText">
                                            <RequiredField IsRequired="true" ErrorText="State Coordinator is required!" />
                                        </ValidationSettings>
                                    </dx:BootstrapComboBox>
                                    <button id="btnWorkGroupLeadHelp" type="button" class="btn btn-link p-0"><i class="fas fa-question-circle"></i>&nbsp;Help</button>
                                </div>
                                <div class="col-lg-3">
                                    <asp:Label runat="server" AssociatedControlID="lblWorkGroupLeadEmail" CssClass="d-block col-form-label" Text="State Coordinator Email"></asp:Label>
                                    <asp:Label ID="lblWorkGroupLeadEmail" runat="server"></asp:Label>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6">
    ...
    <div id="divEditOnly" runat="server" visible="false">
                        ...
                        <div class="card bg-light bold-border">
                            ...
                            <div class="card-body">
                                <div class="alert alert-primary">
                                    <i class="fas fa-info-circle"></i>&nbsp;This section is automatically filled based on the State and action plan timeframe in the Basic Information section.
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                        <label>All active Leadership Team members from the State Leadership Team dashboard</label>
                                        <asp:Repeater ID="repeatLeadershipTeamMembers" runat="server" ItemType="Pyramid.Models.SLTMember">
                                            <HeaderTemplate>
                        ...
                        <div class="card bg-light bold-border">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="alert alert-primary">
                                            <i class="fas fa-info-circle"></i>&nbsp;This section should be used to record all the State Leadership Team meeting dates.
                                        </div>
                                        <label>All meeting dates for the action plan timeframe</label>
                                        <asp:Repeater ID="repeatMeetings" runat="server" ItemType="Pyramid.Models.SLTActionPlanMeeting">
                                            <HeaderTemplate>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                ...
                                                                <button class="dropdown-item delete-gridview hide-on-view" data-pk='<%# Item.SLTActionPlanMeetingPK %>' data-hf="hfDeleteMeetingPK" data-target="#divDeleteMeetingModal"><i class="fas fa-trash"></i>&nbsp;Delete</button>
                                                            </div>
                                                        </div>
                                                        <asp:Label ID="lblMeetingPK" runat="server" Visible="false" Text='<%# Item.SLTActionPlanMeetingPK %>'></asp:Label>
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
                                            <FooterTemplate>
            ...
            <div class="col-xl-12">
                ...
                <asp:UpdatePanel ID="upGroundRule" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
                    <ContentTemplate>
                        <div class="card bg-light bold-border">
                            <div class="card-header">
                                Meeting Ground Rules (Max: 6) (Section 4)
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <asp:Repeater ID="repeatGroundRules" runat="server" ItemType="Pyramid.Models.SLTActionPlanGroundRule">
                                            <HeaderTemplate>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                ...
                                                                <button class="dropdown-item delete-gridview hide-on-view" data-pk='<%# Item.SLTActionPlanGroundRulePK %>' data-hf="hfDeleteGroundRulePK" data-target="#divDeleteGroundRuleModal"><i class="fas fa-trash"></i>&nbsp;Delete</button>
                                                            </div>
                                                        </div>
                                                        <asp:Label ID="lblGroundRulePK" runat="server" Visible="false" Text='<%# Item.SLTActionPlanGroundRulePK %>'></asp:Label>
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
                                            <FooterTemplate>
        ...
        <asp:UpdatePanel ID="upStateAndBOQInfo" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
            <ContentTemplate>
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card bg-light bold-border">
                            <div class="card-header">
                                State Information (Section 5)
                            </div>
                            <div class="card-body">
                                <div class="alert alert-primary">
                                    <i class="fas fa-info-circle"></i>&nbsp;This section is automatically filled based on the State and action plan timeframe in the Basic Information section.
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card bg-light bold-border">
                            <div class="card-header">
                                Benchmark of Quality Information (Section 6)
                            </div>
                            <div class="card-body">
                                <div class="alert alert-primary">
                                    <i class="fas fa-info-circle"></i>&nbsp;This section is automatically filled based on the state and timeframe in the Basic Information section.  
                                    It pulls the most recent Benchmark of Quality form for the state that is on or before the action plan end date and on or after the action plan start date minus six months.
                                    The table below displays all the indicators that are either Not In Place or Emerging/Needs Improvement.
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <asp:Repeater ID="repeatBOQIndicatorsToBeImproved" runat="server" ItemType="Pyramid.Models.spGetBOQSLTIndicatorValues_Result">
                                            <HeaderTemplate>
                                            ...
                                            <ItemTemplate>
                                                <tr class='<%# (Item.IndicatorValue == (int)Pyramid.Models.CodeBOQIndicatorValue.BOQSLTIndicatorValues.EMERGING_NEEDS_IMPROVEMENT ? "alert-warning"
                                                                : Item.IndicatorValue == (int)Pyramid.Models.CodeBOQIndicatorValue.BOQSLTIndicatorValues.NOT_IN_PLACE ? "alert-danger"
                                                                : "") %>'>
                                                    <td></td>
            ...
            <div class="col-xl-12">
                ...
                <asp:UpdatePanel ID="upActionStep" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
                    <ContentTemplate>
                        <div class="card bg-light bold-border">
                            <div class="card-header">
                                Benchmark of Quality Action Steps (Section 7)
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <asp:Repeater ID="repeatActionSteps" runat="server" ItemType="Pyramid.Models.SLTActionPlanActionStep">
                                            <HeaderTemplate>
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td><%# (Item.SLTActionPlanActionStepStatus.OrderByDescending(s => s.StatusDate).FirstOrDefault() == null ? "N/A" : Item.SLTActionPlanActionStepStatus.OrderByDescending(s => s.StatusDate).FirstOrDefault().CodeActionPlanActionStepStatus.Description) %></td>
                                                    <td class="text-center">
                                                        <div class="btn-group">
                                                            <button type="button" class="btn btn-secondary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                                Actions
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                ...
                                                                <button class="dropdown-item delete-gridview hide-on-view" data-pk='<%# Item.SLTActionPlanActionStepPK %>' data-hf="hfDeleteActionStepPK" data-target="#divDeleteActionStepModal"><i class="fas fa-trash"></i>&nbsp;Delete</button>
                                                            </div>
                                                        </div>
                                                        <asp:Label ID="lblActionStepPK" runat="server" Visible="false" Text='<%# Item.SLTActionPlanActionStepPK %>'></asp:Label>
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
                                            <FooterTemplate>
                                                            ...
                                                            <div class="card-body">
                                                                <div class="row">
                                                                    <div class="col-lg-12">
                                                                        ...
                                                                        <asp:Repeater ID="repeatActionStepStatuses" runat="server" ItemType="Pyramid.Models.SLTActionPlanActionStepStatus">
                                                                            <HeaderTemplate>
                                                                                    ...
                                                                                    <td class="text-center">
                                                                                        <div class="btn-group">
                                                                                            ...
                                                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                                                ...
                                                                                                <button class="dropdown-item delete-gridview hide-on-view" data-pk='<%# Item.SLTActionPlanActionStepStatusPK %>' data-hf="hfDeleteActionStepStatusPK" data-target="#divDeleteActionStepStatusModal"><i class="fas fa-trash"></i>&nbsp;Delete</button>
                                                                                            </div>
                                                                                        </div>
                                                                                        <asp:Label ID="lblActionStepStatusPK" runat="server" Visible="false" Text='<%# Item.SLTActionPlanActionStepStatusPK %>'></asp:Label>
                                                                                    </td>
                                                                                </tr>
                                                                            </ItemTemplate>
                                                                            <FooterTemplate>
