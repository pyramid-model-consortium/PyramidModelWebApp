<%@ Page Title="CWLT Agency" Language="C#" MasterPageFile="~/MasterPages/Dashboard.master" AutoEventWireup="true" CodeBehind="CWLTAgency.aspx.cs" Inherits="Pyramid.Pages.CWLTAgency" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <asp:Label ID="lblPageTitle" Text="CWLT Agency" CssClass="h2" runat="server"></asp:Label>
    <hr />
    <asp:HiddenField ID="hfViewOnly" runat="server" Value="False" />
    <asp:UpdatePanel ID="upCWLTAgency" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <uc:Messaging ID="msgSys" runat="server" />
            <asp:HiddenField ID="hfCWLTAgencyPK" runat="server" Value="" />
            <div class="row">
                <div class="col-lg-12">
                    <div class="card bg-light">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-lg-8">
                                    Community Leadership Team Agency
                                </div>
                                <div class="col-lg-4">
                                    <dx:BootstrapButton ID="btnPrintPreview" runat="server" Text="Save and Download/Print" OnClick="btnPrintPreview_Click" 
                                        SettingsBootstrap-RenderOption="primary" ValidationGroup="vgCWLTAgency" data-validation-group="vgCWLTAgency">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-8">
                                    <div class="form-group">
                                        <dx:BootstrapMemo ID="txtName" runat="server" Caption="Name" MaxLength="500" Rows="1">
                                            ...
                                            <ValidationSettings ValidationGroup="vgCWLTAgency" ErrorDisplayMode="ImageWithText">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <dx:BootstrapComboBox ID="ddCWLTAgencyType" runat="server" Caption="Type" NullText="--Select--"
                                            TextField="Name" ValueField="CWLTAgencyTypePK" ValueType="System.Int32" 
            ...
            <div class="page-footer">
                <uc:Submit ID="submitCWLTAgency" runat="server" ValidationGroup="vgCWLTAgency"
                    ControlCssClass="center-content"
                    OnSubmitClick="submitCWLTAgency_Click" OnCancelClick="submitCWLTAgency_CancelClick" 
                    OnValidationFailed="submitCWLTAgency_ValidationFailed" />
            </div>
        </ContentTemplate>
    </asp:UpdatePanel>
</asp:Content>